...
const WDTaskWrapper = styled.div`
  padding: 50px 35px;
...
const WDTaskListWrapper = styled.div`
  width: 100%;
  display: flex;
...
`;
const TaskWrapper = WithDirection(WDTaskWrapper);
const TaskListWrapper = WithDirection(WDTaskListWrapper);
export { TaskWrapper, TaskListWrapper };
